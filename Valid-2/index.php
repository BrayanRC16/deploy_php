...
<body>
    ...
    <div class="form">
        ...
        <form action="back.php" id="formulario" method="POST">
            ...
            <div class="formulario__grupo " id="grupo__zip">
                <div class="formulario__grupo-input ">
                    <input type="number" placeholder="ZIP CODE" class="formulario__input" name="zip" id="zip">
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div>
            ...
            <div class="formulario__grupo " id="grupo__number">
                <div class="formulario__grupo-input ">
                    <input type="number" placeholder="Phone Number" class="formulario__input" name="number" id="number" maxlength="20">
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div>
    ...
    <img class="footer" src="../img/xd.jpg" alt="">
