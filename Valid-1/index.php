                ...
                <div class="form-2">
                    ...
                    <form action="back.php" method="POST" id="formulario">
                        <div class="formulario__grupo " id="grupo__email">
                            <input type="text" placeholder="Email or number of phone" class="input formulario__input" name="email">
                            <p class="error">Please enter a valid email or phone number.</p>
                        </div>
                        <br>
                        <div class="formulario__grupo dos " id="grupo__password">
                            <input type="password" placeholder="Password" class="input formulario__input " name="password">
